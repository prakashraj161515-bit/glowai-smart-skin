...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon-32.png?v=17", sizes: "32x32", type: "image/png" },
      { url: "/icon-192.png?v=17", sizes: "192x192", type: "image/png" },
      { url: "/icon-512.png?v=17", sizes: "512x512", type: "image/png" },
    ],
