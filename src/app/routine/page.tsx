...
export default function RoutinePage() {
  ...
  const fullSchedule = useMemo(() => {
    ...
    const getDietImage = (name: string) => {
      ...
      if (n.includes("apple") || n.includes("seb") || n.includes("pear") || n.includes("persimmon")) return "https://images.unsplash.com/photo-1567306226416-28f0efdc88ce?w=400&q=80";
      ...
      if (n.includes("pomegranate") || n.includes("anar") || n.includes("grapefruit")) return "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=400&q=80";
      ...
      if (n.includes("fruit") || n.includes("grapes") || n.includes("angoor") || n.includes("berries") || n.includes("berry") || n.includes("peaches") || n.includes("raspberries") || n.includes("blueberry") || n.includes("figs") || n.includes("mango") || n.includes("dragon") || n.includes("melon") || n.includes("passion fruit")) return "https://images.unsplash.com/photo-1519996521430-02b798c1d881?w=400&q=80";
      if (n.includes("gourd") || n.includes("lauki") || n.includes("pumpkin") || n.includes("turai") || n.includes("karela") || n.includes("kundru") || n.includes("okra") || n.includes("bamia") || n.includes("eggplant")) return "https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=400&q=80";
      if (n.includes("dates") || n.includes("apricots")) return "https://images.unsplash.com/photo-1547514701-42782101795e?w=400&q=80";
      if (n.includes("salad") || n.includes("carrot") || n.includes("cucumber") || n.includes("gajar") || n.includes("kheera") || n.includes("mooli") || n.includes("beetroot") || n.includes("radish") || n.includes("asparagus") || n.includes("broccoli") || n.includes("kale") || n.includes("spinach") || n.includes("palak") || n.includes("celery") || n.includes("cabbage") || n.includes("brussels") || n.includes("greens") || n.includes("leaves") || n.includes("moringa") || n.includes("chok") || n.includes("pak choy") || n.includes("bok choy") || n.includes("mustard greens") || n.includes("peppers") || n.includes("fennel")) return "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&q=80";
