...
android {
    namespace = "com.cream.skincare.glowai_shell"
    ...
    defaultConfig {
        ...
        applicationId = "com.cream.skincare.glowai_shell"
        // Firebase + Qonversion + InAppWebView need a modern minSdk.
    ...
    buildTypes {
        release {
            ...
            // keeps those classes so release behaves like debug.
